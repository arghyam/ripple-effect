...
const ShareModal: React.FC<ShareModalProps> = ({isModalOpen, onClose, onCopy}) => {
        ...
        <div
            ...
            <div className="w-full max-w-md bg-white shadow-lg rounded-lg p-8 relative">
                <div className="flex items-center pb-3 border-b border-gray-300">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-3.5 cursor-pointer shrink-0 fill-gray-400 hover:fill-red-500" onClick={onClose}
                ...
                <div>
                    ...
                    <div className="w-full rounded-lg overflow-hidden border border-gray-300 flex items-center mt-4">
                        <p className="text-sm text-gray-500 flex-1 ml-4">https://apps.indiawaterportal.org/</p>
